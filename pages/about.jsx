...
import love_black from "@/public/love-black.png";
import love_white from "@/public/love-white.png";
      ...
      <main className="max-w-screen">
        <div className="mx-auto pt-16 -pb-10 max-w-7xl">
          <div className=" mx-auto flex flex-col ">
            ...
            <div className="mx-auto transition-all duration-1000 ease-in-out -mt-8 w-96 h-27">
              <Image
                src={currentTheme === "dark" ? HeroBlack : HeroWhite}
                className="select-none rounded-lg  transition-all duration-300 blur-sm hover:blur-none"
                alt="pranjal shikhar"
                priority
              />
            </div>
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            ...
            <p className="">
              ...
              You can contact me on the ----{" "} <br />
              <span className="text-red-700 font-bold">GMail</span>{" "}
              <a
                onClick={() =>
                  navigator.clipboard.writeText("karthiofficial15@gmail.com")
                }
