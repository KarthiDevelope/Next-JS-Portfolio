...
const Experience = () => {
  ...
  return (
    <div className=" mt-32 lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      <div className="bg-sky-300 w-36 h-36 rounded-lg p-4 select-none ">
        <div className="bg-sky-400  h-28 w-28 flex-col justify-end mx-auto blur-none z-40 items-center text-center text-xl text-white font-medium rounded-lg p-2">
      ...
      <div className="flex flex-col relative space-y-16 md:space-y-10 lg:space-y-8 items-center">
        ...
        <div className="drop-shadow-xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl rounded-[1.4rem] p-4 rounded-tl-none">
          ...
          <div className="font-normal sm:text-[0.95rem] md:text-base text-center">
          Through dedicated learning, Node.js, Express.js, and MongoDB, building a foundation for innovation in web development. With these technologies, I've crafted dynamic projects that showcase my skills and push boundaries. Continuously diving deeper, I embrace new tools and techniques to stay ahead in this ever-evolving field.
          </div>
        </div>
