  ...
  const data = [
    {
      ...
      org: "BLAZON",
      skills: ["HTML", "CSS","Javascript", "React.js", "Redux Toolkit", "Tailwind Css", "Ant Design", "Material Design", "Syncfusion", "Rest Apis", "Websocket Apis"],
      class:
        "bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-1.5 rounded dark:bg-red-900 dark:text-red-300",
    },
    {
      id: 1,
      ...
      org: "Platinum Code",
      skills: ["Manual Testing", "SDLC", "STLC", "Trello", "Unit Testing", "Smoke Testing"],
      class:
